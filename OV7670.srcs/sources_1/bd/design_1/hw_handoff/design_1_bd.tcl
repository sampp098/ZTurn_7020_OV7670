...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BLUE_O [ create_bd_port -dir O -from 3 -to 0 BLUE_O ]
  set GREEN_O [ create_bd_port -dir O -from 3 -to 0 GREEN_O ]
  set HSYNC_O [ create_bd_port -dir O HSYNC_O ]
  set RED_O [ create_bd_port -dir O -from 3 -to 0 RED_O ]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
